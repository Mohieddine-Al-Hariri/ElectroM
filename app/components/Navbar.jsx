...
const Navbar = ({ userSlug, userRole }) => {
  ...
  return (
    <div className=" w-full flex items-center justify-center px-10 fixed z-30 bottom-5 overflow-hidden pointer-events-none">
      ...
      <Link href={`/Cart/${userSlug}`} className={` ${pathName.slice(0,6) === "/Cart/" ? "border-primaryColor " : "border-none "} border-b-2 rounded-full text-[black] hover:bg-primaryColor hover:text-[#f3f3f3] p-2  `}>
      ...
      <Link href="/" className={` ${pathName.length === 1 ? "border-primaryColor " : "border-none "} border-b-2 rounded-full text-[black] hover:bg-primaryColor hover:text-[#f3f3f3] p-2  `}>
      ...
      <Link href={userSlug? `/userProfile/${userSlug}` : "/SignIn"} className={` ${pathName.slice(0,13) === "/userProfile/" ? "border-primaryColor " : "border-none "} border-b-2 rounded-full text-[black] hover:bg-primaryColor hover:text-[#f3f3f3] p-2 `}>
      ...
      {userRole === "Admin" && 
        <Link href="/Admin/orders" className={` ${pathName.slice(0,7) === "/Admin/" ? "border-primaryColor " : "border-none "} border-b-2 rounded-full text-[black] hover:bg-primaryColor hover:text-[#f3f3f3] p-2 `}>
          <svg
            fill="currentColor"
            width="26px"
            height="26px"
